...
def diff_tables(
    ...
    *,
    ...
    # Automatically determine the best bisection factor
    ...
    Parameters:
        ...
        auto_bisection_factor (bool): Should the bisection factor be determined automatically based on table size (used for `HASHDIFF`. default: False)
